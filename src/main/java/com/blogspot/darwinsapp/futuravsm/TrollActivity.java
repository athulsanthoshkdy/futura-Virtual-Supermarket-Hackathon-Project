...
public class TrollActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthlistener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (mAuth.getCurrentUser() == null) {
                    Intent intent = new Intent(TrollActivity.this, RegisterActivity.class);
        ...
        mdatabase = FirebaseDatabase.getInstance().getReference().child("trolls");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog, HomeActivity.BlogzoneViewHolder> FBRA = new FirebaseRecyclerAdapter<Blog, HomeActivity.BlogzoneViewHolder>(
            ...
            protected void populateViewHolder(final HomeActivity.BlogzoneViewHolder viewHolder, final Blog model,final int position) {
                ...
                viewHolder.setImageUrl(TrollActivity.this, model.getImageUrl());
                ...
                viewHolder.share.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        new TrollActivity.DownloadImage().execute(model.getImageUrl());
                ...
                viewHolder.delete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        // Toast.makeText(getApplicationContext(),post_user,Toast.LENGTH_SHORT).show();
                        if (post_user.equals(current_user)){
                            AlertDialog.Builder alertDialog = new AlertDialog.Builder(TrollActivity.this);
    ...
    public void PostMyPhoto(View view) {
        ...
        Intent in = new Intent(TrollActivity.this, PostActivity.class);
        Common.position=101;
        startActivity(in);
    }
    ...
    private class DownloadImage extends AsyncTask<String, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap result) {
            Toast.makeText(TrollActivity.this,"downloaded",Toast.LENGTH_SHORT).show();
    ...
    public void saveImage(Context context, Bitmap b, String imageName) {
        ...
        try {
            ...
            foStream.close();
            Toast.makeText(TrollActivity.this,"saved",Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
